<?php
    ...
    // Get all agencies
    $sql0 = "SELECT AgencyName, AgencyId FROM agencies";
    ...
    <div class="row justify-content-around">
      <div class="wrapper col-10">
        ...
        <?php foreach ($agencyList as $agency) {
            $sql1 = "SELECT agency_employees.FirstName, agency_employees.LastName, agency_employees.Email, agency_employees.MHFRPID, positions.positionName FROM agency_employees INNER JOIN employee_selected ON employee_selected.mhfrpid = agency_employees.MHFRPID INNER JOIN positions ON positions.positionId = agency_employees.PositionID WHERE agency_id = ? AND time_period = ?";
            ...
            foreach ($empList as $emp) {
              ...
              <tr>
                  ...
                  <td>$emp[3]</td>
                  <td>$emp[4]</td>
                  <td><a class='btn btn-primary' href='resend-email.php?id=$emp[3]&email=$emp[2]' role='button'>Email</a></td>
              </tr>
              ";
            }
            echo "</table>";
