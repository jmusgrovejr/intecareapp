<?php
  ...
  if ($type === 'test') {
    $htmlContent = ' 
      ...
      <body> 
          ...
          <p>Please be sure to complete the training during the period of August 26th - September 6th.</p>
  ...
  if ($type === 'official') {
    // Get list of selected employees
