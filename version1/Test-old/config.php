...
function GetEmployeesForExport($id, $agency, $period)
{
	...
	INNER JOIN `agency-data` b on b.IdNumber = a.IdNumber
	INNER JOIN `options` c ON c.value = b.period
	WHERE a.Active =1 AND a.PositionID = '" . $id . "' AND b.InteCareAgencyID = '" . $agency . "' AND b.Period = '" . $period . "' ORDER BY a.LastName, a.FirstName";
