			        ...
			        <a href="#" >
			          <span class="glyphicon glyphicon-minus"></span>
                        ...
                        <div class="col-sm-8 roundcol2" style="color:#3b5cb9">
                            <form id="updateform" name="updateform" method="post" action="detail.php?update=true&IdNumber=<?= $_GET['IdNumber'] ?>&id=<?= $_GET['id'] ?>&name=<?= $_GET['name'] ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <input class="form-control form-rounded" type="text" name="email" id="email" disabled value="<?= (isset($_GET['IdNumber'])) ? $_SESSION['data']['Email'] : '' ?>">
                                    </div>
                                    <div class="col-sm-4">
							...
							<?php 
								echo "<option></option>";
								$positionresult = GetRosterPositions($_SESSION['agencyid'], $_SESSION['period']);
								...
								?>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input class="form-control form-rounded" type="text" name="InteCareAgencyID" id="InteCareAgencyID" value="<?= (isset($_GET['IdNumber'])) ? $_SESSION['data']['InteCareAgencyID'] : '' ?>">
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <input class="form-control form-rounded" type="text" name="IdNumber" id="IdNumber" value="<?= (isset($_GET['IdNumber'])) ? $_SESSION['data']['IdNumber'] : '' ?>">
                                    </div>
                                    <div class="col-sm-4">
                                        <label>MHFRPID</label><br />
                                        <input class="form-control form-rounded" type="text" name="MHFRPID" id="MHFRPID" value="<?= (isset($_GET['IdNumber'])) ? $_SESSION['data']['MHFRPID'] : '' ?>">
                                    </div>
                                ...
                                <div class="row text-center">
                                    <button type="submit" class="btn btn-primary btn-lg" <?= (IsLocked() == 'Yes' ? 'disabled' : '') ?>>Update</button>
                                </div>
                            </form>
                        </div>
