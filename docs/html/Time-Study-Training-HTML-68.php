<div class="container pdf-training">
    ...
    <ol>
        ...
        <li>Any time spent driving during the weekday falls under the same code.</li>
        ...
        <input id="q6True" type="radio" name="q6" value="incorrect" onclick="showResponse6()"> True<br>
        <input id="q6False" type="radio" name="q6" value="correct" onclick="showResponse6()"> False<br>
        ...
        <input id="q7True" type="radio" name="q7" value="incorrect" onclick="showResponse7()"> True<br>
        <input id="q7False" type="radio" name="q7" value="correct" onclick="showResponse7()"> False<br>
